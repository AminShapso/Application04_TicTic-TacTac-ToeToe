...
source.include_exts = py,png,kv,wav,ttf
...
presplash.filename = %(source.dir)s/assets/Icon 01.png

# (str) Icon of the application
icon.filename = %(source.dir)s/assets/Icon 01.png
