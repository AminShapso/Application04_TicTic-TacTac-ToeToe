...
class WelcomeScreen(Screen):
    def __init__(self, **kwargs):
        ...
        layout.add_widget(Label(text='Number of Players:', size_hint=(0.5, None), height=config.widget_height))
        num_players_layout = BoxLayout(orientation='horizontal', size_hint=(1, None), height=config.widget_height)
        ...
        # Grid layout
        grid_layout = BoxLayout(orientation='horizontal', size_hint=(1, None), height=config.widget_height)
        ...
        # Symbol sequence
        symbol_sequence_layout = BoxLayout(orientation='horizontal', size_hint=(1, None), height=config.widget_height)
        ...
        # Start button
        start_button = Button(text='Start Game', size_hint=(1, None), height=config.widget_height)
